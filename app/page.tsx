            ...
            <div className="bank-content-grid-v2">
              ...
              <aside className="bank-side-stack-v2">
                ...
                <article className="bank-ran-card-v2">
                  <img src="/images/ran-assistente-sem-capuz.png" alt="Ran, assistente virtual do RanBank" />
