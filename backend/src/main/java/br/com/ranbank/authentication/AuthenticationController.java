...
public class AuthenticationController {
    ...
    public AuthenticationResult simulate(@RequestParam(defaultValue = "trusted") String scenario) {
        ...
        List<AuthFactor> factors = suspicious
            ? List.of(new AuthFactor("Senha", "aprovado", "Conhecimento"), new AuthFactor("CÃ³digo temporÃ¡rio", "aprovado", "Posse"), new AuthFactor("Biometria facial", "revisar", "InerÃªncia"), new AuthFactor("Comportamento", "bloqueado", "Risco adaptativo"))
            : List.of(new AuthFactor("Senha", "aprovado", "Conhecimento"), new AuthFactor("CÃ³digo temporÃ¡rio", "aprovado", "Posse"), new AuthFactor("Biometria facial", "aprovado", "InerÃªncia"), new AuthFactor("Comportamento", "aprovado", "Risco adaptativo"));
        return new AuthenticationResult(suspicious ? "Novo aparelho e localizaÃ§Ã£o incomum" : "Aparelho e localizaÃ§Ã£o reconhecidos",
